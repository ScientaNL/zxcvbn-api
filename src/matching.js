...
var DATE_MAX_YEAR, DATE_MIN_YEAR, DATE_SPLITS, DICTS, GRAPHS, L33T_TABLE, RANKED_DICTIONARIES_DE, RANKED_DICTIONARIES_EN, RANKED_DICTIONARIES_FR, RANKED_DICTIONARIES_NL, REGEXEN, adjacency_graphs, build_ranked_dict, frequency_lists_de, frequency_lists_en, frequency_lists_fr, frequency_lists_nl, lst, matching, name, scoring;
...
for (name in frequency_lists_de) {
  lst = frequency_lists_de[name];
